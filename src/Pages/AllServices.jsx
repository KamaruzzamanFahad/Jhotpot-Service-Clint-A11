...
const AllServices = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:5000/Servicessearch?text=${text}`, { withCredentials: true })
            .then(res => {
                setservice(res.data)
                setcount(1)
            })
    ...
    return (
        <div>
            ...
            <div className='flex flex-col justify-center items-center'>
                <form style={inputstylthem} className="input input-bordered flex items-center gap-2 w-[90%] md:w-[50%]">
